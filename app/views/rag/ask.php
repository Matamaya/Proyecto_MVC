...
<div class="max-w-2xl mx-auto px-4 py-12 my-12 h-[60vh]">
    <div class="bg-neutral-900 p-8 rounded-2xl shadow-2xl border border-neutral-800">
        ...
        <form action="index.php?action=rag_ask" method="POST" class="space-y-6">
            ...
            <button type="submit"
                class="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-3 px-4 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg transform hover:-translate-y-1">
                Consultar
            </button>
        </form>
    </div>

            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                    ...
                    <input id="email-address" name="email" type="email" autocomplete="email" required
                        ...
                        class="appearance-none rounded-none relative block w-full px-3 py-3 border border-neutral-700 placeholder-gray-500 text-white bg-neutral-950 focus:outline-none focus:ring-orange-500 focus:border-orange-500 focus:z-10 sm:text-sm transition-colors"
